...
// Transact provides a mock function for the type Transactor
func (_mock *Transactor) Transact(ctx context.Context, fn func(ctx context.Context) error) error {
...
// Transactor_Transact_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Transact'
type Transactor_Transact_Call struct {
	*mock.Call
}
...
func (_c *Transactor_Transact_Call) Run(run func(ctx context.Context, fn func(ctx context.Context) error)) *Transactor_Transact_Call {
...
func (_c *Transactor_Transact_Call) Return(err error) *Transactor_Transact_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Transactor_Transact_Call) RunAndReturn(run func(ctx context.Context, fn func(ctx context.Context) error) error) *Transactor_Transact_Call {
	_c.Call.Return(run)
	return _c
}
