...
func (_mock *Repository) Delete(ctx context.Context, u *user.User) error {
...
//   - ctx context.Context
//   - u *user.User
func (_e *Repository_Expecter) Delete(ctx any, u any) *Repository_Delete_Call {
	return &Repository_Delete_Call{Call: _e.mock.On("Delete", ctx, u)}
}

func (_c *Repository_Delete_Call) Run(run func(ctx context.Context, u *user.User)) *Repository_Delete_Call {
...
func (_c *Repository_Delete_Call) RunAndReturn(run func(ctx context.Context, u *user.User) error) *Repository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
//   - email string
func (_e *Repository_Expecter) GetByEmail(ctx any, email any) *Repository_GetByEmail_Call {
...
//   - ctx context.Context
//   - userID uuid.UUID
func (_e *Repository_Expecter) GetByID(ctx any, userID any) *Repository_GetByID_Call {
...
//   - ctx context.Context
//   - u *user.User
func (_e *Repository_Expecter) Store(ctx any, u any) *Repository_Store_Call {
...
//   - ctx context.Context
//   - u *user.User
func (_e *Repository_Expecter) Update(ctx any, u any) *Repository_Update_Call {
