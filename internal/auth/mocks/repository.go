...
// ListSessions provides a mock function for the type Repository
func (_mock *Repository) ListSessions(ctx context.Context, userID uuid.UUID) ([]auth.Session, error) {
...
// Repository_ListSessions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListSessions'
type Repository_ListSessions_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userID uuid.UUID
func (_e *Repository_Expecter) ListSessions(ctx any, userID any) *Repository_ListSessions_Call {
	return &Repository_ListSessions_Call{Call: _e.mock.On("ListSessions", ctx, userID)}
}

func (_c *Repository_ListSessions_Call) Run(run func(ctx context.Context, userID uuid.UUID)) *Repository_ListSessions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Repository_ListSessions_Call) Return(sessions []auth.Session, err error) *Repository_ListSessions_Call {
	_c.Call.Return(sessions, err)
	return _c
}

func (_c *Repository_ListSessions_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID) ([]auth.Session, error)) *Repository_ListSessions_Call {
	_c.Call.Return(run)
	return _c
}
...
// Repository_RevokeUserSessions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RevokeUserSessions'
type Repository_RevokeUserSessions_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userID uuid.UUID
func (_e *Repository_Expecter) RevokeUserSessions(ctx any, userID any) *Repository_RevokeUserSessions_Call {
	return &Repository_RevokeUserSessions_Call{Call: _e.mock.On("RevokeUserSessions", ctx, userID)}
}

func (_c *Repository_RevokeUserSessions_Call) Run(run func(ctx context.Context, userID uuid.UUID)) *Repository_RevokeUserSessions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Repository_RevokeUserSessions_Call) Return(err error) *Repository_RevokeUserSessions_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Repository_RevokeUserSessions_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID) error) *Repository_RevokeUserSessions_Call {
	_c.Call.Return(run)
	return _c
}
